  ...
  ifelse [sprint-num] of one-of sprints = 0 [ 
    ...
    if [hour] of one-of sprints = work-hours-per-day [
      if [day] of one-of sprints = days-per-sprint [
        ask stories with [(dev-tasks + test-tasks) = 0] [ die ]
        layout-circle members with [assigned-to = -1] 10
      ]
...
to-report finished
  report (backlog-count = 0) and (not any? stories)
end
...
to do-work
  ask stories [
    do-dev who
    do-test who
    if (dev-tasks + test-tasks) = 0 [ set color finished-color ]
    ;layout-circle members with [assigned-to = -1] 10
  ]
end
...
to log-work-hours
  set hours-worked-hour hours-worked-hour + 1
  set hours-worked-day hours-worked-day + 1
  set hours-worked-total hours-worked-total + 1
end
...
to show-stats
  ...
  ;print (word "hours worked: " hours-worked-hour ", day: " hours-worked-day ", total: " hours-worked-total)
end
@#$#@#$#@
GRAPHICS-WINDOW
316
